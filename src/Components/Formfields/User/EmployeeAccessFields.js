...
const EmployeeAccessFieldsDefault = [
  {
    label: "First Name",
    tool: "SingleLineText",
    comp: <TextField />,
...
const AdminEmployeeAccessFields = () => {
  useEffect(() => {
    getSchema();
  }, []);
  ...
  const [props, setProps] = useState(EmployeeAccessFieldsDefault);
...
export default AdminEmployeeAccessFields;
